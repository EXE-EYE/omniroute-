...
export function resolveAccountSemaphoreMaxConcurrency(
  credentials: Record<string, unknown> | null | undefined,
  comboConfig: Record<string, unknown> | null | undefined = null
): number | null {
  return (
    toFiniteNumberOrNull(credentials?.maxConcurrent) ??
    toFiniteNumberOrNull(comboConfig?.concurrencyPerModel) ??
